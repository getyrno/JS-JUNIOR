...
// let: Объявляет переменную с областью видимости в блоке кода.
// info: Имя переменной, которая содержит объект.
...
// Тип данных: Object
// Особенности:
//     Объект info содержит три свойства: name, age и favorite_color, значения которых берутся из соответствующих переменных.
